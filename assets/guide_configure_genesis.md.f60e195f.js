import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.1293becd.js";const F=JSON.parse('{"title":"Genesis Block","description":"","frontmatter":{},"headers":[],"relativePath":"guide/configure/genesis.md","filePath":"guide/configure/genesis.md","lastUpdated":1702457319000}'),o={name:"guide/configure/genesis.md"},p=l(`<h1 id="genesis-block" tabindex="-1">Genesis Block <a class="header-anchor" href="#genesis-block" aria-label="Permalink to &quot;Genesis Block&quot;">​</a></h1><p>The <strong>genesis block</strong> is the first block in your blockchain. It&#39;s never empty, even if <code>configs/peer/genesis.json</code> is. Here&#39;s an example:</p><details class="details custom-block"><summary>Genesis Block Example: alice@wonderland</summary><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">{</span></span>
...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div></details><p>The <strong>genesis account</strong> is specified in the <a href="./peer-configuration.html#genesis">peer configuration</a> file, <code>configs/peer/config.json</code>. This is the account that will submit the genesis block. The genesis account is like a super user account that has elevated privileges, but only during the genesis round. The genesis account should be signed by one of the peers, or, in other words, it should have the public key of this peer.</p><p>If you look at the example of a genesis block above, you will see that it contains instructions for registering a new domain (<code>wonderland</code>), two new accounts (<code>alice@wonderland</code> and <code>bob@wonderland</code>), a new asset (<code>rose#wonderland</code>) and a <code>Mint</code> instruction for this asset, as well as several permission tokens and roles. Both new accounts are signed with the <code>ed01207233bfc89dcbd68c19fde6ce6158225298ec1131b6a130d1aeb454c1ab5183c0</code> public key.</p><div class="info custom-block"><p class="custom-block-title">Note</p><p>Iroha is <strong>case-sensitive</strong>, meaning that <em>Alice</em>@wonderland is different from <em>alice</em>@wonderland. It should go without saying that <em>alice@wonderland</em> is not the same as <em>alice@looking_glass</em> either, since these accounts belong to different domains, <code>wonderland</code> and <code>looking_glass</code>.</p></div><p>The accounts registered in the genesis block are just new accounts. As we said above, the <strong>genesis account</strong> is determined in the peer configuration. However, you can use the matching signature for the genesis account and for a new account in the genesis block. Since the genesis account only has privileges during the genesis round, it won&#39;t be a security issue.</p><p>You can generate the default genesis block or create a custom one.</p><p>If you need to recommit a genesis block, remove the previously stored blocks, then restart the Docker container. The new genesis block will be automatically recommited upon container restart.</p><h2 id="generation" tabindex="-1">Generation <a class="header-anchor" href="#generation" aria-label="Permalink to &quot;Generation&quot;">​</a></h2><p>You can add various instructions to the genesis block, such as registering new accounts or assets, as well as minting assets. You can also register permission tokens and roles, as well as grant them to the registered accounts.</p><h3 id="generate-default-genesis-block" tabindex="-1">Generate default genesis block <a class="header-anchor" href="#generate-default-genesis-block" aria-label="Permalink to &quot;Generate default genesis block&quot;">​</a></h3><p>You can use <code>kagami</code> to generate the default genesis block:</p><ul><li><p>Generate a genesis block in JSON format:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">$</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">kagami</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">genesis</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#6F42C1;">$</span><span style="color:#24292E;"> </span><span style="color:#032F62;">kagami</span><span style="color:#24292E;"> </span><span style="color:#032F62;">genesis</span></span></code></pre></div></li><li><p>Generate a genesis block in JSON format and write the output to the specified file:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">$</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">kagami</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">genesis</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">&gt;</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">genesis.json</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#6F42C1;">$</span><span style="color:#24292E;"> </span><span style="color:#032F62;">kagami</span><span style="color:#24292E;"> </span><span style="color:#032F62;">genesis</span><span style="color:#24292E;"> </span><span style="color:#D73A49;">&gt;</span><span style="color:#24292E;"> </span><span style="color:#032F62;">genesis.json</span></span></code></pre></div></li><li><p>Generate a synthetic genesis block in JSON format and write the <code>n</code> domains, <code>m</code> accounts per domain and <code>p</code> assets per domain:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">$</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">kagami</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">genesis</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">--synthetic</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">--domains</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">n</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">--accounts-per-domain</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">m</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">--assets-per-domain</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">p</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#6F42C1;">$</span><span style="color:#24292E;"> </span><span style="color:#032F62;">kagami</span><span style="color:#24292E;"> </span><span style="color:#032F62;">genesis</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--synthetic</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--domains</span><span style="color:#24292E;"> </span><span style="color:#032F62;">n</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--accounts-per-domain</span><span style="color:#24292E;"> </span><span style="color:#032F62;">m</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--assets-per-domain</span><span style="color:#24292E;"> </span><span style="color:#032F62;">p</span></span></code></pre></div></li></ul><p>The genesis block should be located in <code>configs/peer/genesis.json</code>.</p><h2 id="configuration" tabindex="-1">Configuration <a class="header-anchor" href="#configuration" aria-label="Permalink to &quot;Configuration&quot;">​</a></h2><p>As we already explained, <em>genesis account</em> is specified in the peer configuration file, <code>configs/peer/config.json</code>. You can use the same configuration file to fine-tune other <a href="./peer-configuration.html#genesis">genesis block configurations</a>.</p>`,17),e=[p];function t(c,E,r,y,i,u){return n(),a("div",null,e)}const C=s(o,[["render",t]]);export{F as __pageData,C as default};
